...
import 'package:flutter_bayanros/bloc/search_bloc.dart';
import 'package:flutter_bayanros/bloc/user_bloc.dart';
import 'package:flutter_bayanros/counter_bloc.dart';
        ...
        builder: (context, state) => Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: Text("Перейти на следующую страницу"),
            ),
          ],
        ),
      ),
